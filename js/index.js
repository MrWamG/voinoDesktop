...
var app = new Vue({
	...
	mounted() {
		...
		voi_song_list.onclick = (e) => {
			if (e.button == 0) {/* 如果是鼠标左键 */
				_songListFun();
			}
		};
		...
		this.$refs.voi_child_2.onmousedown = function(e) {
			if(e.button == 0){
				nextMusic();
				musicInfo();
				play_svg.style.d = "path('M128 128h768v768H128z')";
		...
		this.$refs.voi_child_4.onmousedown = function(e) {
			if(e.button == 0){
				previousMusic();
				musicInfo();
				play_svg.style.d = "path('M128 128h768v768H128z')";
		...
		this.$refs.voi_child_3.onmousedown = function(e) {
			if(e.button == 0){
				randomMusic();
				musicInfo();
				play_svg.style.d = "path('M128 128h768v768H128z')";
